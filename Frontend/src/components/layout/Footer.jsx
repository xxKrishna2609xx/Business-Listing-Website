    ...
    <div style={{ maxWidth: 1280, margin: '0 auto', padding: '52px 24px 40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 40 }}>
      ...
      <div>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <li>
            <a href="tel:+919876500000" style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 13, color: '#64748b', textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#06b6d4'}
              onMouseLeave={e => e.currentTarget.style.color = '#64748b'}>
              <Phone size={14} style={{ color: '#06b6d4' }} /> +91 98765 00000
            </a>
          </li>
          <li>
